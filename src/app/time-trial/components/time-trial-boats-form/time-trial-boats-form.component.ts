...
import {selectCurrentTimeTrialBoats, selectSelectedBoat} from '../../state/reducers/boat.reducer';
import {SetSelectedBoat} from '../../state/actions/boat.actions';
