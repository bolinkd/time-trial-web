...
export class UpdateBoatMessage implements Action {
  readonly type = BoatActionTypes.UpdateBoatMessage;
...
export class CreateBoatMessage implements Action {
  readonly type = BoatActionTypes.CreateBoatMessage;
